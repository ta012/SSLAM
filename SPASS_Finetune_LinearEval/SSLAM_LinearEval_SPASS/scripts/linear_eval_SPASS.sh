...
eat_dirname=SPASS_Finetune_LinearEval/SSLAM_LinearEval_SPASS/



required_num_epochs=50
linear_eval_lr=0.001
...
for task_data in MARKET PARK SQUARE STREET WATERFRONT; do
    ...
    warmup_update=0 ## no warmup linear eval
    ...
    /path/to/fairseqvenv/bin/python ${main_dir}/fairseq_cli/hydra_train.py -m \
        ...
        task.roll_aug=true \
        optimization.lr=[$linear_eval_lr] \
        optimizer.groups.default.lr_float=$linear_eval_lr \
